    ...
    return (
        <div class="container">
            <div class="privacy-container">
                ...
                <ul>
                    <li><strong>✔️ Personal Information:</strong> Name, email address, phone number, company details, and any information provided through contact forms.</li>
                    <li><strong>✔️ Technical Data:</strong> IP address, browser type, device information, and website usage statistics.</li>
                    <li><strong>✔️ Cookies & Tracking Data:</strong> To enhance your browsing experience, we may use cookies and analytics tools to track user activity.</li>
                </ul>

                <div class="section-header">2. How We Use Your Information</div>
                <p>We collect and use your data for the following purposes:</p>
                <ul>
                    <li>✔️ To provide and improve our services.</li>
                ...
                <ul>
                    <li>✔️ We may use third-party analytics tools (e.g., Google Analytics) to monitor website traffic.</li>
                    <li>✔️ We do not control or assume responsibility for third-party content or data handling.</li>
                </ul>

                <div class="section-header">5. Your Privacy Rights</div>
                <p>You have the right to:</p>
                <ul>
                    <li>✔️ Request access to the personal data we hold about you.</li>
                ...
                <div class="contact-info">
                    <h4>For any questions regarding our Privacy Policy, please contact:</h4>
